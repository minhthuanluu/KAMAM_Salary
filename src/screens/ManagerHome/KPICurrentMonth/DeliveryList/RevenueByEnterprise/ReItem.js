...
const ReItem = (props) => {
    ...
    return (
        <View style={{ flexDirection: "row", backgroundColor: props.type.toUpperCase() == "COMPANY" ? "#FBFDC3" : props.type.toUpperCase() == "BRANCH" ? "#EBFDFD" : "white", borderBottomWidth: 0.2, marginBottom: 0.3, justifyContent: "center", alignItems: "center", minHeight: fontScale(40) }}>
            <Text style={{ flex: 3 / 10, fontSize: fontScale(14), textAlign: "center", fontWeight: props.type.toUpperCase() == "COMPANY" ? "bold" : props.type.toUpperCase() == "BRANCH" ? "600" : "normal" }}>{props.name}</Text>
            <Text style={{ flex: 2 / 10, fontSize: fontScale(14), textAlign: "center", color: props.type.toUpperCase() == "COMPANY" ? "#000101" : props.type.toUpperCase() == "BRANCH" ? "#000101" : "#D19E01" }}>{props.preMonth}</Text>
            <Text style={{ flex: 2 / 10, fontSize: fontScale(14), textAlign: "center", color: props.type.toUpperCase() == "COMPANY" ? "#000101" : props.type.toUpperCase() == "BRANCH" ? "#000101" : "#D19E01" }}>{props.curMonth}</Text>
            <Text style={{ flex: 2 / 10, fontSize: fontScale(14), textAlign: "center", color: props.type.toUpperCase() == "COMPANY" ? "#000101" : props.type.toUpperCase() == "BRANCH" ? "#000101" : "#D19E01" }}>{props.difference}</Text>
