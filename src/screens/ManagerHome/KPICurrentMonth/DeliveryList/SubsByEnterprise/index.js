...
import SeItem from './SeItem';
import { getListSubsEnterprise } from '../../../../../api/manager';
...
const SubsByEnterprise = (props) => {
    ...
    const onPressItem = async (code) => {
        ...
        navigation.navigate("SubsByEnterpriseDetail")
    }
    ...
    const getData = async (month) => {
        setLoading(true)
        let res = await getListSubsEnterprise(month)
                        ...
                        <View >
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return (
                                        <SeItem name={item.name} preMonth={item.preMonth} curMonth={item.curMonth} difference={item.difference} type={item.type} onPress={onPressItem} code={item.code} />
                                    )
