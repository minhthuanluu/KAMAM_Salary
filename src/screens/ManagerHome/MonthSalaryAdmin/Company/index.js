              ...
              <View>
                <GeneralListItem
                  ...
                  monthSalary
                    ...
                    item={[item.permanentSalary, item.maintainceSalary, item.incentiveSalary, item.simSalary, item.totalSalary, item.totalSalary]}
                    icon={images.branch}
                ...
                { index == data.length - 1 ?
                  <GeneralListItem
                    ...
                    titleArray={[, "Lương CĐ", "CP Duy trì","CP Data KK", "CP thay sim", "Tổng CP"]}
                    item={generalData&&[generalData.permanentSalary, generalData.permanentSalary, generalData.permanentSalary,generalData.permanentSalary, generalData.permanentSalary, generalData.permanentSalary, generalData.permanentSalary]}
