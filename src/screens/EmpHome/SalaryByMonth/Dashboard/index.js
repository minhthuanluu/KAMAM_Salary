        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
                <Text style={{ textAlign: "center" }}>
                    <Text style={{ color: "#000000", fontSize: fontScale(18), fontWeight: "bold" }}>Tổng Lương:</Text>
                    <Text style={{ color: "#00BECC", fontSize: fontScale(18), fontWeight: "bold" }}> 15,600,000</Text>
                </Text>
                <MenuItem value="8,000,000" style={{ marginTop: fontScale(40) }} title="Lương cố định" titleMenuStyle={{ paddingTop: fontScale(17) }} icon={images.fixedwage} width={width - fontScale(60)} onPress={() => navigation.navigate("Fixedwage")} />
